...
const PaymentScreen = () => {
	...
	const totalPriceAfterDiscount =
		cuponApplied && subtotal && cupon === 'CANDY50' ? subtotal * 0.5 : subtotal
	...
	const displayRazorpay = async () => {
		...
		const options = {
			...
			amount: totalPriceAfterDiscount && (totalPriceAfterDiscount* 75),
			currency: 'INR',
			name: 'Candy Shop',
			...
			prefill: {
				...
				contact: deliveryAddress && deliveryAddress?.mobile,
			},
			notes: {
